						...
						<AnimateItem className="md:col-span-8 flex flex-col items-center md:items-start text-center md:text-left pb-4 order-2 px-2">
							<AnimateStagger className="flex flex-col items-center md:items-start w-full">
								...
								<AnimateItem>
									...
									>
										BS Information Technology student turning real-world
										problems into seamless, high-performance software. Focused
										on building clean, minimalist interfaces and reliable
										technical solutions.
									</p>
								</AnimateItem>
