...
const IntroPage = () => {
	return (
		<div className="relative mt-3 flex items-center justify-center overflow-hidden">
			...
			<AnimateStagger className="relative z-10 w-full max-w-7xl mx-auto border border-border bg-glass-light dark:bg-glass-dark backdrop-blur-md shadow-2xl px-6 sm:px-12 pb-12 md:pb-6 rounded-[2rem] flex flex-col justify-between min-h-auto mt-0">
				<AnimateItem className="title-bar flex items-center justify-between px-5 py-3 border-b border-border z-10">
				...
				<AnimateItem>
					<AnimateStagger className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 items-center w-full grow mt-4">
					<AnimateItem className="md:col-span-4 flex justify-center md:justify-start relative h-72 sm:h-80 md:h-96 w-full order-1">
					...
					<AnimateItem className="md:col-span-8 flex flex-col items-center md:items-start text-center md:text-left pb-4 order-2 px-2">
						<AnimateStagger className="flex flex-col items-center md:items-start w-full">
							...
							<AnimateItem>
								...
								>
									BS Information Technology student turning real-world problems into
									seamless, high-performance software. Focused on building clean,
									minimalist interfaces and reliable technical solutions.
								</p>
							</AnimateItem>
