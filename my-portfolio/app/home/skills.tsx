...
const Skills = () => {
    ...
    return (
        /* FIXED: Removed 'overflow-hidden' so elements never cut off abruptly */
        <article
            ref={containerRef}
            className="relative h-140 w-full flex items-center justify-center transition-all duration-500 ease-out"
        ...
        >
            ...
            {[80, 130, 180].map((r) => (
                <div
                    ...
                    style={{
                        width: "200px",
                        height: "200px",
                        transform: `scale(${r / 100}) translateZ(0px)`,
                    }}
                />
            ))}
            ...
            {skills.map((skill, index) => {
                ...
                return (
                    ...
                    >
                        <div
                            className="animate-spin-orbit hover:[animation-play-state:paused]"
                            style={
                                {
                                    "--radius": `${radius}px`,
                                    "--angle": `${angle}deg`,
