...
const Experience = () => {
    ...
    return (
        <>
            <AnimateStagger className="w-full py-8 space-y-6">
                {ExperienceData.map((exp) => (
                    ...
                    >
                        ...
                        {/* Added onClick, cursor-pointer, and hover scaling */}
                        <div 
                            onClick={() => handleCardClick(exp)}
                            className="relative w-full max-w-lg border border-black/40 dark:border-border rounded-xl p-5 bg-transparent font-mono transition-all duration-300 hover:border-teal/50 hover:shadow-xl cursor-pointer hover:scale-[1.01]"
                        >
            ...
            {/* Render the modal at the bottom so it mounts properly */}
            <ExperienceModal
                isOpen={isOpen}
