        ...
        <div className="relative grid lg:grid-cols-12 w-full mt-25">
          ...
          <div className="lg:col-span-6 px-4">
            ...
            <div className="w-full py-8 space-y-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="relative flex justify-center lg:justify-end lg:pr-8">
          ...
          <div className="lg:col-span-6 px-4">
            ...
            <div className="w-full py-8 space-y-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="relative flex justify-center lg:justify-start lg:pl-8">
    ...
    <div className="w-full px-4 md:px-0">
      ...
      <section className="max-w-7xl mx-auto mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 justify-items-center w-full mb-20 gap-8">
          {[1, 2, 3].map((i) => (
            <Skeleton key={i} className="h-40 w-full max-w-[300px] rounded-2xl" />
          ))}
        </div>
      </section>
    </div>
